...
int main() {
	...
	Signature signature = SignatureScanner::BuildSignature("ab f6 7c fa ?? 23 e2 4d 6d ?? d3 f5 f4 46 ce ?? 27 c1 23 49 ec db 85");

	void* hit = SignatureScanner::FindNextOccurrence(signature, byte_array_hex);
	...
	std::vector<void*> hits = SignatureScanner::FindAllOccurrences(SignatureScanner::BuildSignature("5a"), byte_array_hex, reinterpret_cast<char*>(byte_array_hex) + 512);
